...
class OozLib(Compressor):
    ...
    def __load_ooz(self):
        ...
        try:
            ...
            local_ooz_path = os.path.join(
                os.path.dirname(__file__), "..", "lib", lib_path
            )
            ...
            try:
                ...
                raise ImportError(
                    "Failed to import 'ooz' module. Install pyooz: pip install pyooz @ git+https://github.com/oMaN-Rod/pyooz.git"
                )
        self.ooz = ooz
